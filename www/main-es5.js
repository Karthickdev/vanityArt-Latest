...
var map = {
	"./bolscan/bolscan.module": [
		"./src/app/bolscan/bolscan.module.ts",
		"bolscan-bolscan-module"
	],
	"./bolscanning/bolscanning.module": [
	...
	"./reportsip/reportsip.module": [
		"./src/app/reportsip/reportsip.module.ts",
		"reportsip-reportsip-module"
	],
	"./scanreturns/scanreturns.module": [
...
var ApiserviceService = /** @class */ (function () {
    ...
    function ApiserviceService(http, toastController, loadingCtrl, alert) {
        this.http = http;
        ...
        this.trackingitems = "ordersapi/TrackingDetails";
        this.serialScan = "ordersapi/VerifySerialNumber";
        // saveitems: string = "ordersapi/UpdateBolScan";
        // savetrckingitems: string = "ordersapi/UpdateTracking";
        this.saveitems = "ordersapi/UpdateBolScanV2";
        this.savetrckingitems = "ordersapi/UpdateTrackingV2";
        this.getReport = "ordersapi/Report";
        this.exportreports = "ordersapi/ExportReport";
        this.orderList = "ordersapi/OrderStatusList";
        this.warehouseList = "ordersapi/ScanAppWarehouseList";
        this.errorMsg = "UserApi/GetResponseMessages";
        this.readyToShipped = "ordersapi/UpdateReadyToShipped";
        this.serialScanreturn = "ordersapi/GetOrderItemDetailsBySerialNumber";
        this.poScan = "ordersapi/ScanPoNumber";
        this.save = "OrdersApi/SaveReturn";
        this.itemScan = "OrdersApi/ValidateItemScan";
    }
    ApiserviceService.prototype.PresentToast = function (msg, color) {
    ...
    ApiserviceService.prototype.present = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    ApiserviceService.prototype.dismiss = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ApiserviceService.prototype.ajaxCallService = function (dataUrl, dataType, dataParam) {
        var _this = this;
    ...
    ApiserviceService.prototype.presentAlert = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var alert;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
var AppComponent = /** @class */ (function () {
    ...
    function AppComponent(platform, splashScreen, statusBar, Vanityartservice) {
    ...
    AppComponent.prototype.getErrorMessages = function () {
        var _this = this;
        var url = this.Vanityartservice.baseUrl + this.Vanityartservice.errorMsg;
        var mode = this.Vanityartservice.baseUrl.includes("https") ? "PROD" : "UAT";
        this.Vanityartservice.ajaxCallService(url, "post", '').then(function (resp) {
            console.log(resp);
            _this.Vanityartservice.errorMessages = resp['messages'];
            localStorage.setItem("Message", JSON.stringify(resp['messages']));
            if (mode == "UAT") {
                if (resp['appVersionUAT'] != _this.version) {
                    _this.Vanityartservice.presentAlert();
                    _this.Vanityartservice.versionChecked = false;
                }
                else {
                    _this.Vanityartservice.versionChecked = true;
                }
            }
            else {
                if (resp['appVersionPRD'] != _this.version) {
                    _this.Vanityartservice.presentAlert();
                    _this.Vanityartservice.versionChecked = false;
                }
                else {
...
module.exports = __webpack_require__(/*! /Users/user181180/Documents/vanityArt-latest/vanityArt-Latest/src/main.ts */"./src/main.ts");
