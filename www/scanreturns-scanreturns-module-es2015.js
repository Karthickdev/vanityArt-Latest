...
let ScanreturnsPage = class ScanreturnsPage {
    constructor(formBuilder, Vanityartservice, route, keyboard, activatedRoute, alertCtrl, routerOutlet, camera, file, http) {
    ...
    takePhoto(type) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const tempImage = yield this.camera.getPicture(this.cameraOptions);
