...
var ScanreturnsPage = /** @class */ (function () {
    function ScanreturnsPage(formBuilder, Vanityartservice, route, keyboard, activatedRoute, alertCtrl, routerOutlet, camera) {
            ...
            for (var _i = 0, _a = _this.photoType; _i < _a.length; _i++) {
                ...
                if (item.typeName == type.typeName) {
                    ...
                    if (item.typeName == 'Return Label') {
                        _this.returnLabelPhoto = base64Image;
                    }
                    else if (item.typeName == 'SKU') {
                        _this.skuPhoto = base64Image;
                    }
                    else if (item.typeName == 'Damaged Area') {
                        _this.damagedAreaPhoto = base64Image;
                    }
                    else if (item.typeName == 'Up front') {
                        _this.upFrontPhoto = base64Image;
                    }
                }
            }
            if (_this.returnLabelPhoto && _this.skuPhoto && _this.damagedAreaPhoto && _this.upFrontPhoto) {
                _this.enableSaveBtn = true;
            }
            else {
